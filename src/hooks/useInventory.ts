...
const initialDemoData: InventoryItem[] = [
  ...
  { id: '4', name: 'Projector', type: 'Electronics', dateAdded: new Date().toISOString(), status: 'In Maintenance', quantity: 1, imageUrl: 'https://picsum.photos/400/300?id=4', location: 'Meeting Room 1', supplier: 'AV World' },
];
