...
const initialDemoData: InventoryItem[] = [
  ...
  { id: '3', name: 'Wireless Mouse', type: 'Accessories', dateAdded: new Date().toISOString(), status: 'Available', quantity: 0, imageUrl: 'https://picsum.photos/400/300?id=3', expiryDate: new Date(Date.now() + 15 * 24 * 60 * 60 * 1000).toISOString(), location: 'Storage', supplier: 'TechSupplier Inc.', shelfId: 'SH-01', weight: 100, reorderThreshold: 5, reorderQuantity: 20 },
  ...
  { id: '5', name: 'External Hard Drive', type: 'Accessories', dateAdded: new Date().toISOString(), status: 'Low Stock', quantity: 2, imageUrl: 'https://picsum.photos/400/300?id=5', location: 'Storage', supplier: 'DataSafe', shelfId: 'SH-01', weight: 250, reorderThreshold: 3, reorderQuantity: 15 },
];
